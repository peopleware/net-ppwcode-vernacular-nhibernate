...
- `PPWCode.Vernacular.NHibernate.III.CastleWindsor`, a Castle Windsor _facility_ for setup and registration when using Castle Windsor as dependency injection container
- `PPWCode.Vernacular.NHibernate.III.DI`, a helper for setup and registration when using the Microsoft DI container
...
Development of the PPWCode is done on https://github.com/peopleware/net-ppwcode-vernacular-nhibernate/tree/III/next[GitHub].

Releases (both stable and pre-release) are published on https://www.nuget.org/packages/PPWCode.Vernacular.NHibernate.III/[NuGet] by https://www.nuget.org/profiles/PeopleWare[PeopleWare].
